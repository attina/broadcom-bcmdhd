...
# TPUT Enhancement
	...
	DHDCFLAGS += -DUSE_WL_TXBF -DUSE_WL_FRAMEBURST
# TCP SYNC flood attack block
	DHDCFLAGS += -DDHDTCPSYNC_FLOOD_BLK -DTCP_SYNC_FLOOD_LIMIT=5000
# Keep alive
	DHDCFLAGS += -DKEEP_ALIVE -DCUSTOM_KEEP_ALIVE_SETTING=30000
# Packet filter
...
#	DHDCFLAGS += -DARP_DETECTION #-DARP_DETECTION_BCAST_SCAN
...
# SAE/WPA offload
ifeq ($(CONFIG_BCMDHD_WPA_OFFLOAD),y)
	DHDCFLAGS += -DWL_SAE_STD_API
	DHDCFLAGS += -DBCMSUP_4WAY_HANDSHAKE -DWL_ENABLE_IDSUP
	DHDCFLAGS += -DWL_IDAUTH #-DWL_AP_4WAY_HS_BKPORT
	DHDCFLAGS += -DWL_OWE_OFFLD #-DWL_OWE_OFFLD_BKPORT
...
#	DHDCFLAGS += -DCFG80211_INFO_CHANDEF
	...
	DHDOFILES += wl_cfgvendor.o wl_cfgmdnsoffload.o
endif
